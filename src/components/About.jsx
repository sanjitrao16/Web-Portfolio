      ...
      <div className="About-Section min-h-screen bg-gradient-to-b from-[#110f10] via-[#1a1819] to-[#110f10] py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="gap-12 items-start">
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="backdrop-blur-md bg-white/5 border border-[#80f9ff]/20 rounded-2xl p-6 md:p-8 shadow-lg hover:border-[#80f9ff]/40 transition-colors duration-300">
                  <p className="text-[#dddddd] text-sm md:text-lg leading-relaxed mb-4">
                    ...
                    Additionally, I have also explored and worked in domains
                    like Machine Learning and Artificial Intelligence. I also
                    solve problems on platforms like LeetCode and GeeksForGeeks
                    to enhance my problem-solving skills.
                  </p>
                  <p className="text-[#dddddd] text-sm md:text-lg leading-relaxed mb-4">
                    Currently I am serving as the Technical Co-Head and Web-Dev
                    Lead at GeeksForGeeks CampusBody Student Club. As a leader
                    and part of the technical team, I've delivered a workshop on
                    ...
                    have also worked on numerous projects both individually and
                    as part of a team, which you can find below as well as on my
                    resume.
                  </p>
                  <p className="text-[#dddddd] text-sm md:text-lg leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="group backdrop-blur-md bg-gradient-to-br from-white/5 to-white/[0.02] border border-[#80f9ff]/20 rounded-2xl p-6 md:p-8 hover:border-[#80f9ff]/50 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-[#80f9ff]/10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-[#e8e8e8]">
                  Education
                </h3>
              </div>
            ...
            <div className="group backdrop-blur-md bg-gradient-to-br from-white/5 to-white/[0.02] border border-[#80f9ff]/20 rounded-2xl p-6 md:p-8 hover:border-[#80f9ff]/50 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-[#80f9ff]/10">
              ...
              <p className="text-sm md:text-base text-[#8b8b8b] mb-4">
                <span className="block text-[#e8e8e8] font-semibold mb-2">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-3 text-sm md:text-base text-[#8b8b8b]">
