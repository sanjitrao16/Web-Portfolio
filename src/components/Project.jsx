    ...
    <div className="Project-Section min-h-screen bg-gradient-to-b from-[#110f10] via-[#1a1819] to-[#110f10] py-16 px-6">
      <div className="max-w-7xl mx-auto">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col h-full">
                <h3 className="text-2xl font-bold text-[#e8e8e8] mb-3 group-hover:text-[#80f9ff] transition-colors duration-300">
                  {project.title}
                </h3>

                <p className="text-[#8b8b8b] leading-relaxed mb-6 flex-grow">
                  {project.description}
                </p>

                <div className="mb-6">
                  <p className="text-sm text-[#80f9ff] font-semibold mb-3 uppercase tracking-wider">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, idx) => (
                      <span
                        key={idx}
                        className="text-xs text-[#e8e8e8] bg-[#80f9ff]/10 border border-[#80f9ff]/30 px-3 py-1 rounded-lg hover:border-[#80f9ff]/60 transition-colors duration-300"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        <div className="mt-12 text-center backdrop-blur-md bg-gradient-to-r from-[#80f9ff]/8 to-transparent border border-[#80f9ff]/18 rounded-xl p-6 hover:border-[#80f9ff]/30 transition-colors duration-200">
          ...
          <p className="text-[#9aa0a6] mb-4 max-w-xl mx-auto text-sm">
